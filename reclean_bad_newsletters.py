"""
Re-clean newsletters with bad titles - INVESTOR GRADE
"""
...
# Newsletter IDs from comprehensive scan
NEWSLETTER_IDS = [42, 81, 113, 146, 149, 150, 157, 158, 159, 160]

def reclean_newsletters(newsletter_ids):
    conn = sqlite3.connect('data/articles.db')
    cursor = conn.cursor()

    print(f"Re-cleaning {len(newsletter_ids)} newsletters to INVESTOR GRADE quality...")
    print()
    ...
    print()
    print("="*80)
    print("[SUCCESS] Re-cleaning complete to INVESTOR GRADE!")
    print("="*80)
